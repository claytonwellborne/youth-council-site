...
import { LayoutGrid, Users, Inbox, BookOpenText, FolderOpen, ExternalLink, LogOut } from 'lucide-react';
    ...
    <aside className={`h-screen sticky top-0 border-r bg-white ${collapsed?'w-[68px]':'w-64'} transition-all`}>
      <div className="p-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          {!collapsed && <div className="text-sm"><div className="font-semibold">Project 18</div><div className="text-gray-500">Admin</div></div>}
        </div>
      ...
      <nav className="px-3 space-y-1">
        ...
        <Item to="/admin/directory" icon={Users}>Directory</Item>
        <Item to="/admin/releases" icon={BookOpenText}>Research & Policy</Item>
        <Item to="/admin/applications" icon={Inbox}>Ambassador Applications</Item>
        <Item to="/admin/resources" icon={FolderOpen}>Resources</Item>
      </nav>
