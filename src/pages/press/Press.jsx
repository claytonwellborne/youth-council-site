  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden">        <div className="mx-auto max-w-6xl px-4 pt-24 pb-12 text-center">
          ...
          <h1    className="text-4xl md:text-5xl font-extrabold text-center p18-gradient-text text-center p18-gradient-text text-center p18-gradient-text">Our Press</h1>
